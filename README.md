<!-- GitHub Profile README for Frontend Lead - Prateek Sharma -->

<div align="center" style="background: linear-gradient(to right, #1f4037, #99f2c8); padding: 2rem; border-radius: 12px; color: #fff;">
  <h1 style="font-size: 3em;">Hey, I'm <span style="color:#0f172a;">Prateek Sharma</span> 👋</h1>
  <h3 style="color:#0f172a;">Frontend Lead | Building performant, scalable UIs</h3>
  <p style="max-width: 600px; margin: auto; font-size: 1.1em; color: #0f172a;">
    I specialize in building modern web applications with a strong focus on performance, accessibility, and team-driven development.
    Currently leading frontend efforts with React and Next.js to ship scalable, production-ready interfaces.
  </p>
</div>
...
<p align="center">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg" width="40" title="Next.js" style="background:white; border-radius:4px;" />
...
<p align="center">
  ...
  <a href="mailto:prateek.pixel@gmail.com" target="_blank">
